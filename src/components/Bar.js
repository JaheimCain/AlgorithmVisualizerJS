...
function Bar({index, length, color, changeArray}) {
    ...
    ['rgba(131, 232, 90, 1)', 'rgba(131, 90, 232, 0.2)',]];
        ...
        <> 
            <div className="bar" >
                ...
                <div className = "side right" >
                    <div className = "color-bar right-color-bar" style = {F_B_L_R}>

                    </div>
                </div>

                <div className = "side left" >
                    <div className = "color-bar left-color-bar" style = {F_B_L_R}>

                    </div>
                </div>
                <div className="side front" >
                    <div className="color-bar front=color-bar" style = {F_B_L_R}>
                <input 
                type = "number" 
                length = {length} 
                style = {inputStyle} 
            ...
            <div className = "side back">
                <div className = "color-bar back-color-bar" style = {F_B_L_R}>
